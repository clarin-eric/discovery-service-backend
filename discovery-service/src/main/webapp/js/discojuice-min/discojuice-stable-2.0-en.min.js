...
var DiscoJuice={Constants:{Countries:{EU:"European Union",AF:"Afghanistan",AX:"\u00c5land Islands",AL:"Albania",DZ:"Algeria",AS:"American Samoa",AD:"Andorra",AO:"Angola",AI:"Anguilla",AQ:"Antarctica",AG:"Antigua and Barbuda",AR:"Argentina",AM:"Armenia",AW:"Aruba",AC:"Ascension Island",AU:"Australia",AT:"Austria",AZ:"Azerbaijan",BS:"Bahamas",BH:"Bahrain",BD:"Bangladesh",BB:"Barbados",BY:"Belarus",BE:"Belgium",BZ:"Belize",BJ:"Benin",BM:"Bermuda",BT:"Bhutan",BO:"Bolivia",BQ:"Bonaire, Sint Eustatius and Saba",BA:"Bosnia and Herzegovina",
...
d=this.parent.Utils.options.get("metadata"),e=[],g={},h=null,f;"string"===typeof d?e.push(d):"object"===typeof d&&d&&(e=d);if("object"===typeof c&&c)this.data=c;this.parent.Utils.log("metadataurl is "+d);if(d){c=this.parent.Utils.options.get("disco");if(this.parent.Utils.options.get("discoSetRequestor",!1))g.entityID=c.spentityid;a.parent.Utils.log("Setting up load() waiter");c=DiscoJuice.Utils.waiter(function(){a.parent.Utils.log("load() waiter EXECUTE");a.postLoad()},1E4);for(f=0;f<e.length;f++)h=
e[f],c.runAction(function(c){var d=f+1;$.ajax({url:h,dataType:"json",jsonpCallback:function(){return"dj_md_"+d},cache:!0,data:g,success:function(f){a.data=$.merge(a.data,f);a.parent.Utils.log("Successfully loaded metadata ("+f.length+") ("+d+" of "+e.length+")");c()}})},function(){var c=h;return function(){a.ui.error("Metadata retrieval from ["+c+"] to slow. Ignoring response.")}}());c.startTimer()}}},postLoad:function(){var a=this,c;if(this.data){for(i=0;i<this.data.length;i++)if(!this.data[i].title&&
...
c&&(!d||this.data[i].subID))if(!(d&&d!==this.data[i].subID)&&(!this.data[i].subID||d)){if(isNaN(this.data[i].weight))this.data[i].weight=0;this.data[i].weight+=a;this.parent.Utils.log("COOKIE Setting weight to "+this.data[i].weight);return}this.parent.Utils.log("DiscoJuice setWeight failer (no entries found for) "+c+" # "+d)},discoResponseError:function(a,c){this.parent.Utils.log("DiscoResponse ERROR Received cid="+a);a&&this.runCallback(a);c&&this.ui.error(c)},discoResponse:function(a,c,d,e){this.parent.Utils.log("DiscoResponse Received from ["+
...
"?entityID="+escape(h)+"&isPassive=true&returnIDParam=subID&return="+escape(g);d.parent.Utils.log("iFrame URL is  ["+iframeurl+"]");d.parent.Utils.log("return URL is  ["+g+"]");e='<iframe src="'+iframeurl+'" style="display: none"></iframe>';d.ui.addContent(e)})}},discoWrite:function(a,c){var d=this.parent.Utils.options.get("disco");if(!d)return!1;if(!d.writableStore)return!1;var e="",e=d.url,g=d.spentityid,h=d.writableStore;this.parent.Utils.log("DiscoJuice.Control discoWrite()");if(c){this.parent.Utils.log("DiscoJuice.Control discoWrite(...)");
return d.subIDwritableStores&&d.subIDwritableStores[a]?(this.parent.Utils.log("DiscoJuice.Control discoWrite("+a+") with SubID ["+c+"]"),iframeurl=d.subIDwritableStores[a]+escape(c),this.parent.Utils.log("DiscoJuice.Control discoWrite iframeURL ("+iframeurl+") "),this.ui.addContent('<iframe src="'+iframeurl+'" style="display: none"></iframe>'),!0):!1}this.parent.Utils.log("DiscoJuice.Control discoWrite("+a+") to "+h);iframeurl=DiscoJuice.Utils.addQueryParam(h,"origin",g);iframeurl=DiscoJuice.Utils.addQueryParam(iframeurl,
"IdPentityID",a);iframeurl=DiscoJuice.Utils.addQueryParam(iframeurl,"isPassive","true");iframeurl=DiscoJuice.Utils.addQueryParam(iframeurl,"returnIDParam","bogus");iframeurl=DiscoJuice.Utils.addQueryParam(iframeurl,"return",e);this.parent.Utils.log("DiscoJuice.Control discoWrite iframeURL (2)("+iframeurl+") ");this.ui.addContent('<iframe src="'+iframeurl+'" style="display: none"></iframe>');return!0},searchboxSetup:function(){var a=this,c=function(a){var c={delay:400,counter:0};c.callback=a;c.ping=
function(a){c.counter++;setTimeout(function(){0===--c.counter&&c.callback(a)},c.delay)};return c}(function(){term=a.ui.popup.find("input.discojuice_search").val();1!==term.length&&a.prepareData()});this.ui.popup.find("input.discojuice_search").keydown(function(d){var e;if(d&&d.which)e=d.which;else if(window.event)d=window.event,e=d.keyCode;13==e?a.hitEnter():27==e?a.ui.hide():c.ping(d)});this.ui.popup.find("input.discojuice_search").change(function(a){c.ping(a)});this.ui.popup.find("input.discojuice_search").mousedown(function(a){c.ping(a)})},
...
return a}DiscoJuice.Hosted={getConfig:getConfig,setup:function(a,c,d,e,g,h){var f;f=getConfig(c,d,e,g,h);$(document).ready(function(){$(a).DiscoJuice(f)})}};DiscoJuice.Version="2.0 (2012-01-13 13:50)";"undefined"==typeof DiscoJuice&&(DiscoJuice={});
